...
rover \
  ...
  -var-folder /tf/caf/configuration/level2/connectivity/virtual_networks/management/data_management \
  ...
  -level level2 \
  -w tfstate \
  -p ${TF_DATA_DIR}/connectivity_virtual_networks_data_management.tfstate.tfplan \
  -a plan
