...
rover \
  ...
  -var-folder /tf/caf/configuration/level2/connectivity/virtual_networks/management/non_prod \
  ...
  -level level2 \
  -w tfstate \
  -p ${TF_DATA_DIR}/connectivity_virtual_networks_management_non_prod.tfstate.tfplan \
  -a plan
