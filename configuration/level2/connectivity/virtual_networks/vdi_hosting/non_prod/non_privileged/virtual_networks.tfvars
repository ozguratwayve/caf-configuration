vnets = {
  vdi_hosting_non_privileged = {
    resource_group_key = "vdi_hosting_non_privileged_connectivity_corp"
    region             = "region1"
    vnet = {
      name          = "vnet-connectivity-vdi-hosting-non-privileged-corp"
      address_space = ["10.103.144.0/20"]
      dns_servers_keys = {
        ip1 = {
     ...
     subnets = {
      vdi_hosting_non_privileged = {
        name            = "vdi_hosting_non_privileged"
        cidr            = ["10.103.146.0/23"]
