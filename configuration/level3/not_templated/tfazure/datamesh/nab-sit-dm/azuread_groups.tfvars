azuread_groups = {
  dm_aadg_landingzone_readers = {
    name        = "sit-dm-landingzone-readers"
  ...
  dm_aadg_landingzone_contributors = {
    name        = "sit-dm-landingzone-contributors"
  ...
  dm_aadg_databricks_readers = {
    name        = "sit-dm-databricks-readers"
  ...
  dm_aadg_databricks_eda_read = {
    name        = "sit-dm-databricks-eda-read"
  ...
  dm_aadg_databricks_bc01_read = {
    name        = "sit-dm-databricks-bc01-read"
  ...
  dm_aadg_databricks_bc02_read = {
    name        = "sit-dm-databricks-bc02-read"
  ...
  dm_aadg_databricks_support_write = {
    name        = "sit-dm-databricks-support-write"
