storage_accounts = {
  ...
  dm_sa_billing = {
    ...
    private_endpoints = {
      dm_pe_storage_dfs_billing = {
        ...
        private_service_connection = {
          name                 = "dm-plnkconn-sa-dfs-billing"
          is_manual_connection = false
          subresource_names    = ["dfs"]
        }
      ...
      dm_pe_storage_blob_billing = {
        ...
        private_service_connection = {
          name                 = "dm-plnkconn-sa-blob-billing"
          is_manual_connection = false
          subresource_names    = ["blob"]
        }
  ...
  # Mock Data Lake for pol-dev-dm only.
  dm_sa_datatrandls = {
    name                     = "datatrandls"
    resource_group_key       = "dm_rg_storage"
    account_kind             = "StorageV2"
    ...
    private_endpoints = {
      dm_pe_storage_dfs_datatrandls = {
        name               = "dfs-datatrandls"
        resource_group_key = "dm_rg_networking"
        vnet_key           = "dm_vnet_core"
        subnet_key         = "dm_snet_core_storage_pri"

        private_service_connection = {
          name                 = "dm-plnkconn-sa-dfs-datatrandls"
          is_manual_connection = false
          subresource_names    = ["dfs"]
        }
      ...
      dm_pe_storage_blob_datatrandls = {
        name               = "blob-datatrandls"
        resource_group_key = "dm_rg_networking"
        vnet_key           = "dm_vnet_core"
        subnet_key         = "dm_snet_core_storage_pri"

        private_service_connection = {
          name                 = "dm-plnkconn-sa-blob-datatrandls"
          is_manual_connection = false
          subresource_names    = ["blob"]
        }
