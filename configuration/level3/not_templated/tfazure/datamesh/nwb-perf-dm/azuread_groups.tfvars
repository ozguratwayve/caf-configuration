azuread_groups = {
  dm_aadg_landingzone_readers = {
    name        = "perf-dm-landingzone-readers"
  ...
  dm_aadg_landingzone_contributors = {
    name        = "perf-dm-landingzone-contributors"
  ...
  dm_aadg_aks_admins = {
    ...
    members = {
      ...
      user_principal_names = [
        "alex.gherasim_keymate.co.uk#EXT#@keymatedev.onmicrosoft.com",
        "diogo.pinto_keymate.co.uk#EXT#@keymatedev.onmicrosoft.com",
        "serban.constantinescu_endava.com#EXT#@keymatedev.onmicrosoft.com",
      ]
    }
    owners = {
      user_principal_names = [
  ...
  dm_aadg_databricks_admins = {
    name        = "perf-dm-databricks-admins"
  ...
  dm_aadg_databricks_readers = {
    name        = "perf-dm-databricks-readers"
  ...
  dm_aadg_superset_std_read = {
    name        = "perf-dm-superset-std-read"
  ...
  dm_aadg_superset_enh_read = {
    name        = "perf-dm-superset-enh-read"
  ...
  dm_aadg_databricks_eda_read = {
    name        = "perf-dm-databricks-eda-read"
  ...
  dm_aadg_databricks_bc01_read = {
    name        = "perf-dm-databricks-bc01-read"
  ...
  dm_aadg_databricks_bc02_read = {
    name        = "perf-dm-databricks-bc02-read"
  ...
  dm_aadg_databricks_support_write = {
    name        = "perf-dm-databricks-support-write"
