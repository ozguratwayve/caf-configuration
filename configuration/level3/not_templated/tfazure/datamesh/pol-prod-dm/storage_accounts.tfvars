storage_accounts = {
  ...
  # Aggregate Storage Account required by pol-prod-dm only.
  dm_sa_aggregate = {
    name                     = "aggregate"
    resource_group_key       = "dm_rg_storage"
    account_kind             = "StorageV2"
    ...
    private_endpoints = {
      dm_pe_storage_dfs_aggregate = {
        ...
        private_service_connection = {
          name                 = "dm-plnkconn-sa-dfs-aggregate"
          is_manual_connection = false
          subresource_names    = ["dfs"]
        }
      ...
      dm_pe_storage_blob_aggregate = {
        ...
        private_service_connection = {
          name                 = "dm-plnkconn-sa-blob-aggregate"
          is_manual_connection = false
          subresource_names    = ["blob"]
        }
