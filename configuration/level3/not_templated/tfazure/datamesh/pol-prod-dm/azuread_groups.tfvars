azuread_groups = {
  dm_aadg_landingzone_readers = {
    name        = "prod-dm-landingzone-readers"
    ...
    owners = {
      user_principal_names = [
        ...
        "pascal.jerome_keymate.co.uk#EXT#@keymatedev.onmicrosoft.com"
      ]
    }
    prevent_duplicate_name = true
  }
  dm_aadg_landingzone_contributors = {
    name        = "prod-dm-landingzone-contributors"
  ...
  dm_aadg_databricks_admins = {
    name        = "prod-dm-databricks-admins"
  ...
  dm_aadg_databricks_readers = {
    name        = "prod-dm-databricks-readers"
  ...
  dm_aadg_superset_std_read = {
    name        = "prod-dm-superset-std-read"
  ...
  dm_aadg_superset_enh_read = {
    name        = "prod-dm-superset-enh-read"
  ...
  dm_aadg_databricks_eda_read = {
    name        = "prod-dm-databricks-eda-read"
  ...
  dm_aadg_databricks_bc01_read = {
    name        = "prod-dm-databricks-bc01-read"
  ...
  dm_aadg_databricks_bc02_read = {
    name        = "prod-dm-databricks-bc02-read"
  ...
  dm_aadg_databricks_support_write = {
    name        = "prod-dm-databricks-support-write"
