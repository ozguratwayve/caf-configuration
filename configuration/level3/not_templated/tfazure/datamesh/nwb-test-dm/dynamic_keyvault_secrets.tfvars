dynamic_keyvault_secrets = {
  dm_kv_secrets = {
    dm_dks_landingzone_key = {
      output_key    = "client_config"
      resource_key  = "client_config"
      secret_name   = "landingzone-key"
      attribute_key = "landingzone_key"
    }
    dm_dks_tenant_id = {
      output_key    = "client_config"
      resource_key  = "client_config"
    ...
    #   attribute_key = "primary_access_key"
    # }
    # TODO: Unavailable in CAF v5.6.3
    # dm_dks_dks_adbc_core_cluster_id = {
    #   output_key    = "cluster"
    #   resource_key  = "dm_adbc_core"
    #   secret_name   = "nwb-test-dm-dbw-core-cluster-id"
