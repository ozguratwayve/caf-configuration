azuread_groups = {
  dm_aadg_landingzone_readers = {
    name        = "test-dm-landingzone-readers"
  ...
  dm_aadg_landingzone_contributors = {
    name        = "test-dm-landingzone-contributors"
  ...
  dm_aadg_databricks_admins = {
    name        = "test-dm-databricks-admins"
  ...
  dm_aadg_databricks_readers = {
    name        = "test-dm-databricks-readers"
  ...
  dm_aadg_superset_std_read = {
    name        = "test-dm-superset-std-read"
  ...
  dm_aadg_superset_enh_read = {
    name        = "test-dm-superset-enh-read"
  ...
  dm_aadg_databricks_eda_read = {
    name        = "test-dm-databricks-eda-read"
  ...
  dm_aadg_databricks_bc01_read = {
    name        = "test-dm-databricks-bc01-read"
  ...
  dm_aadg_databricks_bc02_read = {
    name        = "test-dm-databricks-bc02-read"
  ...
  dm_aadg_databricks_support_write = {
    name        = "test-dm-databricks-support-write"
